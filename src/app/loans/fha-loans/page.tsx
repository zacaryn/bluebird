            ...
            <div className="bg-[#00659C] text-white rounded-xl p-8 my-12 shadow-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-white/20 text-white border-2 border-white px-6 py-3 rounded-lg hover:bg-white hover:text-[#00659C] transition-colors text-center font-semibold"
                >

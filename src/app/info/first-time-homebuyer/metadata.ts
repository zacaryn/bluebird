...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'First-Time Homebuyer Guide Colorado Springs | Programs & Tips',
    description: 'Expert guidance for first-time homebuyers in Colorado Springs. Learn about loan programs and the homebuying process.',

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://bluebirdmortgage.com',
  },
};
            ...
            <div className="mx-auto max-w-2xl py-24 sm:py-32 lg:py-40">
              <div className="text-center">
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Link
                    href="/get-started"
                    className="w-full sm:w-auto rounded-md bg-white px-5 py-3 text-base font-semibold text-[#00659C] shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-colors text-center"
                  >
                    Get Started
                  </Link>
                  <a
                    href="tel:719-428-1038"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-md bg-[#00659C] px-5 py-3 text-base font-semibold text-white shadow-sm hover:bg-[#005483] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#00659C] transition-colors text-center"
                  >

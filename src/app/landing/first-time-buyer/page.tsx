...
export default function FirstTimeBuyerLanding() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative isolate">
        <div className="absolute inset-0 -z-10">
          ...
          >
            <source src="/images/buyhome.mp4" type="video/mp4" />
            {/* Fallback image in case video doesn't load */}
            <Image
              src="/images/homebuyer.jpg"
              alt="First Time Homebuyer Colorado Springs"
              fill
          ...
          <div className="mx-auto max-w-4xl py-24 sm:py-32 lg:py-40">
            <div className="text-center">
              ...
              <p className="mt-6 text-xl leading-8 text-gray-100 max-w-2xl mx-auto drop-shadow">
                Get approved with as little as 3% down. Most Colorado Springs renters qualify for homeownership today.
              </p>
      ...
      {/* Animated Buy vs Rent Comparison */}
      <BuyVsRentComparison 
        monthlyRent={2200}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-8">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Get Approved With As Little As 3% Down
            </h2>
          </div>
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 text-center">
                <div className="text-3xl font-bold text-[#00659C] mb-2">3.5%</div>
                <div className="font-semibold text-gray-900 mb-2">FHA Loans</div>
                <div className="text-sm text-gray-600">580+ credit score</div>
              </div>

              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 text-center">
                <div className="text-3xl font-bold text-[#00659C] mb-2">3%</div>
                <div className="font-semibold text-gray-900 mb-2">Conventional</div>
                <div className="text-sm text-gray-600">First-time buyer programs</div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-6 text-center">
                ...
                <div className="font-semibold text-gray-900 mb-2">VA Loans</div>
                <div className="text-sm text-gray-600">For qualified veterans</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <AnimatedStats 
        title="First-Time Buyer Success in Colorado Springs"
        subtitle="See why thousands choose homeownership with our help"
        className="bg-white"
        stats={[
          {
            value: 97,
            suffix: '%',
            label: 'Approval Rate',
            description: 'First-time buyers we help get approved',
            icon: (
          ...
          },
          {
            ...
            suffix: '%',
            label: 'Down Payment',
            description: 'As low as with FHA loans',
            icon: (
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          },
          {
            value: 580,
            label: 'Credit Score',
            description: 'Minimum score for FHA loans',
            icon: (
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          },
          {
            value: 15,
            label: 'Days to Close',
            description: 'Average time from app to keys',
            icon: (
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Get Your Free Homebuying Consultation
            </h2>
            <p className="mt-4 text-lg text-white/90">
              Let's see how much home you can afford and which programs you qualify for. 
              No obligation, just expert guidance from David Jeffrey.
            </p>
          </div>
              ...
              {submitSuccess ? (
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Your information has been submitted. David Jeffrey will contact you within 24 hours to discuss your homebuying options.
                  </p>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="currently-renting">Currently renting, want to buy</option>
                      <option value="pre-approval">Need pre-approval</option>
                      <option value="down-payment-help">Need down payment assistance</option>
                      <option value="credit-concerns">Have credit concerns</option>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#00659C] sm:text-sm"
                      placeholder="What kind of home are you looking for? What's your timeline? Any specific questions or concerns?"
                    />
                    {errors.message && (
                  ...
                  >
                    {isSubmitting ? 'Sending...' : 'Start My Homebuying Journey →'}
                  </button>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-base leading-7 text-gray-600">
              See what our satisfied first-time homebuyers say about their experience with David Jeffrey.
            </p>
          </div>
      ...
      <div className="bg-white py-16">
        <div className="mx-auto max-w-4xl text-center px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Every month you rent is another month you're not building equity. 
            Let's get you into your own home today.
          </p>
